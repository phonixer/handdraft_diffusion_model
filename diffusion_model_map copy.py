...
class Diffusion(nn.Module):
    def __init__(self, loss_type, beta_schedule, clip_denoised, predict_epsilon, obs_dim, act_dim, hidden_dim, device, T):
        ...
        self.model = MLPMap(self.state_dim, self.action_dim, self.hidden_dim, self.device, 16, 8, 20, 2, 3, 1, 10, 256, 320).to(device)
